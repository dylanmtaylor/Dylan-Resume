...
\namesection{Dylan M. Taylor}{ \urlstyle{same}\href{https://dylanmtaylor.com}{dylanmtaylor.com} |
\href{mailto:dylan@dylanmtaylor.com}{dylan@dylanmtaylor.com} | 412.390.7295 | Durham, North Carolina 27703
}
...
\hspace*{\fill}\location{ Research Triangle Park, North Carolina }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{EDUCATION}
\runsubsection{Penn State Erie, the Behrend College}
\hspace*{\fill}\location{ Erie, Pennsylvania }
%\vspace{\topsep} % Hacky fix for awkward extra vertical spac
\begin{tightemize}
