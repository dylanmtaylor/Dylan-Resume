...
\section{CAREER}
\runsubsection{\href{https://www.ibm.com/}{International Business Machines}}
\hspace*{\fill}\location{\href{https://www.rtp.org/}{Research Triangle Park, North Carolina}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{EDUCATION}
\runsubsection{\href{http://behrend.psu.edu/}{Penn State Erie, the Behrend College}}
\hspace*{\fill}\location{\href{http://www.erie.pa.us/}{Erie, Pennsylvania}}
%\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
