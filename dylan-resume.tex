...
\begin{tightemize}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\item {As part of the pipelines team, developed CI/CD solutions for multiple projects, as well as several container images for software builds, and a Terraform Tomcat module to deploy software within the company in a standardized and approved manner with an ELK stack and service monitoring and alerting.}
